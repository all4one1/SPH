...
#define wP6D2Grad(r)	-24.0*pow((H2-r*r),2)*r/(Pi*H8) 
#define wP6D3Grad(r)	-(945.0/32.0)*pow((H2-r*r),2)*r/(Pi*H9)
...
#define wSpikyD2Grad(r)	-30.0*pow((H-r),2)/(Pi*H5)
#define wSpikyD3Grad(r)	-45.0*pow((H-r),2)/(Pi*H6)
...
#define wViscD2Grad(r)	(10.0/3.0)*(-(1.5)*r*r/H3+2.0*r/H2-(0.5)*H/(r*r))/(H2*Pi)
#define wViscD3Grad(r)	(15.0/2.0)*(-(1.5)*r*r/H3+2.0*r/H2-(0.5)*H/(r*r))/(H3*Pi)
#define wViscD2Lapl(r)	(5.0/3.0)*(H4+8.0*H*r*r*r-9.0*r*r*r*r)/(H5*r*r*r*Pi)
